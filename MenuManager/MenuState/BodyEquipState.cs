...
public class BodyEquipState : MenuState
{
  ...
  public void Start(){
    ...
    InfoWindowText.text = "";
    InventoryList = InventoryManager.ReturnInventoryList(ItemType.Body);
    foreach(int ItemID in InventoryList) {
      if(ItemID == PlayerManager.Player.Equip.body.ItemId){
  ...
  public void CursolOn(){
    ...
    if(CursolPos == 0){
        ...
        MenuManager.SetMenuState("BodyEquipComand");
      }
  }
  public void End(){
